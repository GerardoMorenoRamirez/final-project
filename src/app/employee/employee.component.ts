            ...
            findEmployee: Employee;
             constructor(private dataService: EmployeeService) {
                this.newEmployee = new Employee();
                 ...
                 ngOnInit() { // console.log("in ngOnInit"); //this.employeeList = this.dataService.employeeList;
                   this.getAll();
                   }
                                ...
                                //console.dir(item);
                                 //console.log("In addEmployee: " + this.newEmployee);
                                  this.dataService.addEmployee(this.newEmployee).subscribe(employee => {
                                     this.employeeList.push(employee); console.dir(employee); });
                                   ...
                                   getEmployeeById() { this.dataService.getEmployee(this.findEmployee.id).subscribe(
                                      e => {
                                         if (e != undefined) this.findEmployee = e;
                                         },
                                          error => 
